...
public class Journey_Details extends JFrame{  //Forth
    ...
    JTable table;
    JLabel ReservationDetails,Fcode,Jnydate,Jnytime,Source,Destination,label,label1;
    JButton Show;
	...
	Show.addActionListener(new ActionListener(){
		...
		try{
                    ...
                    String str = "select f_code,jny_date,jny_time,src,dst from reservation where src = '"+src+"' and dst = '"+dst+"'";
