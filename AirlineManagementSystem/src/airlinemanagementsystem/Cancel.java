...
private void initialize(){
    ...
    ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("airlinemanagementsystem/icon/cancel.png"));
...
//    add(Ticketid);
    ...
    tf2 = new JTextField();
    tf2.setBounds(250,200,150,27);
    add(tf2);
    
//    tf3 = new JTextField();
//    tf3.setBounds(250,250,150,27);
//    add(tf3);
    
    tf4 = new JTextField();
    tf4.setBounds(250,300,150,27);
    add(tf4);
    
    Cancel.addActionListener(new ActionListener(){
        public void actionPerformed(ActionEvent ae){
             
            String passenger_no = tf.getText();
           
            String cancellation_date = tf2.getText();
           
            String flight_code = tf4.getText();
            
            try{
                Conn c = new Conn();
                String str ="INSERT INTO cancellation values('"+passenger_no+"', '"+cancellation_date+"', '"+flight_code+"')";
                String str2= "DELETE FROM passenger WHERE pnr_no='"+passenger_no+"'";
